...
public class Shopper extends User implements Serializable {
	 ...
	 *             the not available exception
	 */
	public void addProductToCart(int prodID, int demand) throws NotAvailableException {
		cart.addProduct(prodID, demand, this.back);
	}
